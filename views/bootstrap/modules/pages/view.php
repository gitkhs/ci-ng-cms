    <div class="row">
        <div class="col-sm-12">
            <a class="btn btn-default" role="button" href="<?=$site['r']?>/<?=$param['class']?>/write/mid/<?=$param['mid']?>">글작성</a>
        </div>
    </div>
    ...
    <img src="<?=$site['r']?>/<?=$site['img']?>/bg_iphone.png" class="img-responsive">
    </div> 
    <div class="col col-sm-4">
    <img src="<?=$site['r']?>/<?=$site['img']?>/400x180.png" class="img-responsive">
    <h4>Aside</h4>
    <hr>
    <img src="<?=$site['r']?>/<?=$site['img']?>/400x180.png" class="img-responsive">
    <h4>Aside 2</h4>
